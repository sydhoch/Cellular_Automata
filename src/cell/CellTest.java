...
public class CellTest {
    ...
    public void PPfishMoved(){
        ...
        pp1.checkNeighborStatus(neighbors,map);
        int expected = 0;
    ...
    public void PPsharkMoved(){
        ...
        pp2.checkNeighborStatus(neighbors,map);
        int expected = 0;
    ...
    public void FireBurningToEmpty(){
        ...
        f2.checkNeighborStatus(neighbors,map);
        int expected = 0;
    ...
    public void FireEmptyToEmpty(){
        Cell[] neighbors = {f0,f1,f2,f0,f0,f0,f0};
        f0.checkNeighborStatus(neighbors,map);
        int expected = 0;
    ...
    public void SegSatisfactionWithNoNeighbors(){
        ...
        s1.checkNeighborStatus(neighbors,map);
    ...
    public void setRockToPaper(){
        ...
        r0.checkNeighborStatus(neighbors,map);
        int expected = 1;
    ...
    public void scissorsToRock(){
        ...
        r2.checkNeighborStatus(neighbors,map);
        int expected = 0;
    ...
    public void openPercCellFilled(){
        ...
        p0.checkNeighborStatus(neighbors,map);
        int expected = 1;
    ...
    public void closedPercCellStayClosed(){
        Cell[] neighbors = {p0,p0,p0,p0,p1,p2,p2,p2};
        p2.checkNeighborStatus(neighbors,map);
        int expected = 2;
    ...
    public void fullPercCellStayFull(){
        Cell[] neighbors = {p0,p0,p0,p0,p1,p2,p2,p2};
        p1.checkNeighborStatus(neighbors,map);
        int expected = 1;
    ...
    public void aliveGoLCellKilledByUnderPopulation(){
        ...
        g1.checkNeighborStatus(neighbors,map);
        int expected = 0;
    ...
    public void deadGoLCellBroughtBack(){
        ...
        g0.checkNeighborStatus(neighbors,map);
        int expected = 1;
